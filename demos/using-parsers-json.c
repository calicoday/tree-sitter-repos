...
// now with shunting...
// wd be:
// -I /usr/local/include/tree_sitter.0.20.0
// -I /usr/local/include/tree_sitter_json.0.19.0
// -L /usr/local/lib/tree-sitter
// -L /usr/local/lib/tree-sitter-json
// libtree-sitter.0.20.0.a
// libtree-sitter-json.0.19.0.a
/*
clang -v \
  -I /usr/local/include/tree_sitter.0.20.6 \
  -I /usr/local/include/tree_sitter_json.0.19.0 \
  -L /usr/local/lib/tree-sitter \
  -L /usr/local/lib/tree-sitter-json \
  using-parsers-json.c \
  /usr/local/lib/tree-sitter/libtree-sitter.0.20.6.a \
  /usr/local/lib/tree-sitter-json/libtree-sitter-json.0.19.0.a \
  -o using-parsers-json
*/
